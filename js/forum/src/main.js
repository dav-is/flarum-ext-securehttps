...
app.initializers.add('davis-securehttps-forum', function() {
    extend(CommentPost.prototype, 'init', function() {
        const proxy = app.forum.attribute('davis-securehttps.proxy');
        if(proxy == true || proxy == undefined || proxy == '') {
            ...
            while ((myArray = myRe.exec(this.props.post.contentHtml())) !== null) {
                ...
                this.props.post.contentHtml = m.prop(
                    this.props.post.contentHtml().replace(
                        myArray[0],
                        '<img src="'+app.forum.attribute('apiUrl')+'/davis/securehttps/'+myArray[1]+'/" title="'+myArray[2]+'" alt="'+myArray[3]+'">'
                    )
                );
            }
        } else {
            this.props.post.contentHtml = m.prop(
                ...
                this.props.post.contentHtml().replace(
                    ...
                    '<img onerror="$(this).next().empty().append(\'<blockquote style=&#92;&#39;background-color: #c0392b; color: white;&#92;&#39; class=&#92;&#39;uncited&#92;&#39;><div><p>'+app.translator.trans('davis-securehttps.forum.removed')+'| <a href=&#92;&#39;#&#92;&#39; onclick=&#92;&#39;window.open(&#92;&#34;http://$1&#92;&#34;,&#92;&#34;name&#92;&#34;,&#92;&#34;width=600,height=400&#92;&#34;)&#92;&#39;>'+app.translator.trans('davis-securehttps.forum.show')+'</a></p></div></blockquote>\');$(this).hide();" onload="$(this).next().empty();" class="securehttps-replaced" src="https://$1" title="$2" alt="$3"><span><br><br><i class="icon fa fa-spinner fa-spin fa-3x fa-fw"></i> Loading Image<br></span>'
                )
            );
        }
    });
